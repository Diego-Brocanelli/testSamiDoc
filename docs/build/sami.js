...
(function(root) {
    ...
    var bhIndex = null;
    var rootPath = '';
    var treeHtml = '        <ul>                <li data-name="namespace:" class="opened">                    <div style="padding-left:0px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href=".html">App</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="namespace:App_Controller" class="opened">                    <div style="padding-left:18px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="App/Controller.html">Controller</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:App_Controller_AppController" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="App/Controller/AppController.html">AppController</a>                    </div>                </li>                </ul></div>                </li>                            <li data-name="namespace:App_Model" class="opened">                    <div style="padding-left:18px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="App/Model.html">Model</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:App_Model_Product" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="App/Model/Product.html">Product</a>                    </div>                </li>                </ul></div>                </li>                            <li data-name="namespace:App_Service" class="opened">                    <div style="padding-left:18px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="App/Service.html">Service</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:App_Service_ProductList" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="App/Service/ProductList.html">ProductList</a>                    </div>                </li>                </ul></div>                </li>                </ul></div>                </li>                </ul>';
    ...
    var searchIndex = [
            ...
            {"type": "Class", "fromName": "App\\Controller", "fromLink": "App/Controller.html", "link": "App/Controller/AppController.html", "name": "App\\Controller\\AppController", "doc": "&quot;&quot;"},
                                                        {"type": "Method", "fromName": "App\\Controller\\AppController", "fromLink": "App/Controller/AppController.html", "link": "App/Controller/AppController.html#method_getProduct", "name": "App\\Controller\\AppController::getProduct", "doc": "&quot;Get data product.&quot;"},
